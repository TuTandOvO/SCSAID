...
<main class="developer-analytics" aria-labelledby="analyticsTitle">
    ...
    <p class="developer-analytics__intro">Exact visitor addresses and country lookup from counted page visits. This page is intentionally absent from public navigation and requires server-configured developer credentials.</p>
    <p class="developer-analytics__privacy">Address history is retained for 90 days and is available only through this protected developer view.</p>
    ...
    <section class="developer-analytics__panel" aria-labelledby="addressTitle">
        <div class="developer-analytics__panel-head"><div><p class="developer-analytics__eyebrow">Developer-only</p><h2 id="addressTitle">Recent visitor addresses</h2></div><span class="developer-analytics__range">Last 90 days · latest 200</span></div>
        <div class="developer-analytics__table-wrap"><table><thead><tr><th>IP address</th><th>Country</th><th>Visits</th><th>First seen (UTC)</th><th>Last seen (UTC)</th></tr></thead><tbody id="visitorRows"><tr><td colspan="5">Loading protected visitor history…</td></tr></tbody></table></div>
    </section>
